...
"/Users/vishnu/.local/bin/uv" run uvicorn api:app --host 0.0.0.0 --port 8765 --workers 1 --log-level info >> "/Users/vishnu/Documents/Tracxn/SR/publishing-sr/TypeB/Logs/api.logs" 2>&1
